...
export const hu: Messages = {
  ...
  landing: {
    ...
    more: {
      kicker: 'És csendben, a margón',
      heading: 'Minden más, ami az InkMirrorben van',

      g1Label: 'Írófelület',
      g1Item1: 'Blokk-alapú szerkesztő 60 FPS-es virtualizálással 100k szó felett is',
      g1Item2: 'Hat blokktípus és hat fejezet-típus, köztük Borító, Ajánlás, Mottó, Köszönetnyilvánítás, Utószó',
      g1Item3: 'Beszélőfelismerés a "Név: Helló" mintából és POV-igazított párbeszéd',
      g1Item4: 'Parancspaletta (Cmd/Ctrl+K) és teljesen átköthető gyorsbillentyű-térkép',
      g1Item5: 'Cselekmény-idővonal nézet minden fejezeten át',

      g2Label: 'A tükör',
      g2Item1: 'Story Pulse — a hangulat élő EKG-hullámformaként',
      g2Item2: 'Hangulat-hőtérkép-csík az egész kéziraton',
      g2Item3: 'Karakterenkénti hangulat, jelenetről jelenetre követve',
      g2Item4: 'Környezeti szonifikáció — a fejezet hangulata generatív akkordként',
      g2Item5: 'Ellentmondás-felismerés a karakterleírásokon',

      g3Label: 'Emlékezet',
      g3Item1: 'Dead Text Graveyard — minden törölt blokk visszaállítható',
      g3Item2: 'Blokkonkénti változatkezelés visszaállítással',
      g3Item3: 'Dokumentum- és teljes-DB-szintű biztonsági mentés .inkmirror-csomagként',
      g3Item4: 'Visszavonás a törléseken, típusváltásokon és szerkesztéseken át',

      g4Label: 'Bárhol, a magad módján',
      g4Item1: 'Hat export — Markdown, EPUB, PDF, Fountain, DOCX, JSON',
      g4Item2: 'Magyar és angol, két kattintással átváltható',
      g4Item3: 'PWA — a dokkba telepíthető, offline fut',
      g4Item4: 'Csökkentett mozgás végig tiszteletben tartva',
